...
public class BerserkerAI : MonoBehaviour
{
    ...
    [SerializeField] private EnemyDamage swordHitbox; // ← espada aquí
    ...
    public float restDuration = 3f; // 💤 descanso después de 5 ataques

    [Header("Balance de agresión")]
    public int attacksBeforeRest = 5; // 🔢 cuántos ataques antes del descanso
    ...
    private IEnumerator AttackRoutine()
    {
        ...
        // 💥 Si llegó al límite de ataques, entra en descanso
    ...
    private IEnumerator RestRoutine()
    {
        ...
        attackCounter = 0;
        animator.SetBool("IsRunning", false);
        animator.SetTrigger("Tired"); // 🔹 (opcional: animación de cansancio)
