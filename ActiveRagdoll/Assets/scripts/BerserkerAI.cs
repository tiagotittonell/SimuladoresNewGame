...
//    private Vector3 attackPivotPosition;
...
//        {
//            FacePlayer();
//            rb.velocity = Vector3.zero; // aseguro freno
//            return;
//        }
...
//    private void MoveTowardsPlayer()
//    {
//        if (!canMove) return;  // ⬅ DETIENE el movimiento REAL
...
//        // 🔥 Guardar posición EXACTA al iniciar el ataque
//        attackPivotPosition = transform.position;
...
//        // 🔥 MANTENER AL ENEMIGO QUIETO DURANTE TODA LA ANIMACIÓN
//        while (timer < animLength)
//        {
//            // Mantener posición fija
//            rb.MovePosition(attackPivotPosition);

//            // Pero seguir mirando al jugador
//            FacePlayer();
